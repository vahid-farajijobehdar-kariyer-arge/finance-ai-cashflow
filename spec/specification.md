...
| `installment_number` | Current installment | Mevcut taksit numarası | Integer |
...
| Exclude / Hariç | Refunds, cancellations, failed | İadeler, iptaller, başarısız |
...
| Task | EN | TR | Status |
|------|-----|-----|--------|
| 1.1 | Excel/CSV ingestion for all 8 banks | 8 banka için Excel/CSV okuma | ⏳ |
| 1.2 | Column mapping configuration per bank | Banka bazında sütun eşleştirme | ⏳ |
| 1.3 | Data validation with error reporting | Hata raporlamalı veri doğrulama | ⏳ |
| 1.4 | Net amount calculation | Net tutar hesaplama | ⏳ |

### Phase 2: Aggregation / Faz 2: Toplama
| Task | EN | TR | Status |
|------|-----|-----|--------|
| 2.1 | Bank-level summaries | Banka düzeyinde özetler | ⏳ |
| 2.2 | Daily/Weekly/Monthly aggregations | Günlük/Haftalık/Aylık toplamlar | ⏳ |
...
| Task | EN | TR | Status |
|------|-----|-----|--------|
| 3.1 | Interactive web dashboard | İnteraktif web paneli | ⏳ |
| 3.2 | Bank comparison view | Banka karşılaştırma görünümü | ⏳ |
| 3.3 | Cash flow timeline | Nakit akış zaman çizelgesi | ⏳ |
| 3.4 | Export to Excel | Excel'e dışa aktarma | ⏳ |
...
*Last updated / Son güncelleme: January 27, 2026*
